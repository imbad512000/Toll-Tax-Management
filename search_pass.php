                               ...
                               <h3 class="auth-title">Search Pass</h3>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group mb-3">
                                      <div class="row">
                                        <input class="form-control col-5 ml-2" type="text" id="cid" name="name" required="" placeholder="Search Pass">
                                        <button class="btn btn-danger btn-block col-1 ml-2" type="submit" name="sub1"><i class="fa fa-search"></i></button>
                                    </div>
