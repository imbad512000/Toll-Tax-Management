...
<head>
    ...
    <!-- Fonts
     ================================================== -->
    <link href='https://fonts.googleapis.com/css?family=Montserrat:400,700%7COpen+Sans:400,300,600,700' rel='stylesheet'
        type='text/css'>
        ...
        <div class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="500"
                        data-thumb="images/main-banner/3/6.jpg" data-saveperformance="on" data-title="">

                        <!-- MAIN IMAGE -->
                        <img src="images/main-banner/3/6.jpg" alt="" data-lazyload="images/main-banner/3/6.jpg"
                            data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
    ...
    <section class="bg-blue why-people-chose-us">
        <div class="container">
            <div class="heading text-center animate bounceIn">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut
                    labore.</p>
            </div>
            ...
            <div class="footer-top clearfix">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="footer-logo animate fadeInLeft"><a href="index.html"><img src="images/logo.png"
                                    alt=""></a></div>
                    </div>
                    <div class="col-md-9 col-sm-9">
                        <p>Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor Neque porro
                            quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipis civelit sed quia
                            non qui dolorem or phone +11 987 654 3210 ipsum quia dolor sit amet, consectetur.</p>
                    </div>
                </div>
                ...
                <div class="footer-left">
                    <div class="footer-address-widget clearfix">
                        <ul>
                            ...
                            <li><i class="icon-icons74"></i>Bhatia Toll Plaza,<span>Surat, SH-168, Surat Road, Surat,
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <p>Coyright © 2020. All rights reserved.</p>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <p class="text-right">Designed by <a href="https://www.facebook.com/Siddharth.kans">Siddharth
                                Kansara </a>& <a href="">Bhavik Desai</a></p>
                    </div>
                </div>
            </div>
        </div>
