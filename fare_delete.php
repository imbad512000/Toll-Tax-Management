                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card" style="height: 525px;">
                            ...
                            <div class="card-body p-4" >
                               ...
                               <center><h3 class="auth-title">Delete Vehicle Category</h3></center>
                                <br><br><br>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group mb-3">
                                            <label for="inputEmail3" class="col-5 col-form-label">Vehicle Type<span class="text-danger">*</span></label>
                                            <div class="">
                                                  <select class="form-control" name="type_of_vehicle" data-style="btn-light">
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-danger btn-block" type="submit" name="sub1">Delete </button>
                                    </div>
