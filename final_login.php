                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card" >
                            ...
                            <div class="card-body p-4" style="border-style: solid";>
                               ...
                               <center><h3 class="auth-title">Sign In</h3></center>
                                <br>
                            ...
                            <div class="col-12 text-center">
                                ...
                                <p class="text-muted">Don't have an account? <a href="reg.php" class="" ss="text-muted ml-1"><b class="font-weight-semibold">Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <br><br>
 <?php
