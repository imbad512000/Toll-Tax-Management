<?php 
    ...
    class myPDF extends FPDF{    
        function header(){
                ...
                $this->Cell(250,20,'Customer details',0,0,'C');
                $this->Ln();
                $this->Ln();
                $this->Ln();
                // $this->Ln();
            ...
            function headerTable(){
                ...
                $this->Cell(38,10,'First name',1,0,'C');
                $this->Cell(38,10,'last name',1,0,'C');
            ...
            function viewTable($con){
                ...
                while ($row=mysqli_fetch_assoc($res)){
                    $this->Cell(38,10,$row["cust_reg_first_name"],1,0,'C');
                    $this->Cell(38,10,$row["cust_reg_last_name"],1,0,'C');
                    $this->Cell(32,10,$row["cust_reg_gender"],1,0,'C');
                    $this->Cell(65,10,$row["cust_reg_email"],1,0,'C');
                    $this->Cell(40,10,$row["cust_reg_password"],1,0,'C');
                    $this->Cell(40,10,$row["cust_reg_DOB"],1,0,'C');
