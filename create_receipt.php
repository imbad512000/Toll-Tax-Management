   ...
   <ul class="sidebar-menu">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          ...
          <li><a href="search_receipt.php"><i class="zmdi zmdi-dot-circle-alt"></i> Search Receipt</a></li>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card" style="height: 1090px; width: 480px;">
                            ...
                            <div class="card-body p-4" >
                               ...
                               <center><h3 class="auth-title">Create Receipt</h3></center>
                                <br><br><br>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="tbname" required=""  placeholder="Enter your Toll Booth Name">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                     ...
                                     <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="ename" required="" placeholder="Enter your employee name"  >
                                    </div>
                                     ...
                                     <div class="form-group mb-3">
                                            <label for="inputEmail3" class="col-5 col-form-label">Vehicle Cagetory<span class="text-danger"></span></label>
                                            <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                            <label for="inputEmail3" class="col-5 col-form-label">Type of Journey<span class="text-danger"></span></label>
                                            <div class="">
                                                  <select class="form-control" name="type_of_journey" data-style="btn-light">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="vno" required="" placeholder="Enter your Vehicle Number" ><!-- pattern="[G][J][0-9][0-9][A-Z][A-Z][0-9][0-9][0-9][0-9]" -->
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="tel" name="tamount" required=""><!-- disabled="disabled" -->
                                    </div>
                                    
                                    <br><br>
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-danger btn-block" type="submit" name="sub1"> Create Receipt </button>
                                    </div>
