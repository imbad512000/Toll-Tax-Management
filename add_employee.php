                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-7">
                                                <input type="text" required parsley-type="text" class="form-control"
                                                       id="inputtext" placeholder="First Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="hori-pass1" class="col-4 col-form-label">Last Name<span class="text-danger">*</span></label>
                                            <div class="col-7">
                                                <input id="hori-pass1" type="text" placeholder="Last Name" required
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="hori-pass1" class="col-4 col-form-label">Gender <span class="text-danger">*</span></label>
                                            <div class="col-4">
                                            <input type="radio" name="GenM">Male
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="GenF">Female
                                        </div><br>
                                         <div class="form-group row">
                                            <label for="hori-pass1" class="col-7 col-form-label">Last Name<span class="text-danger">*</span></label>
                                            <div class="col-0">
                                                <input id="hori-pass1" type="text" placeholder="Last Name" required
                                                       class="form-control">
                                            </div>
