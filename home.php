...
<!-- Mirrored from wahabali.com/work/advisor/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jan 2020 07:55:51 GMT -->
<head>
            ...
            <header id="header" class="header-three h-three-h">
				...
				<div class="container-fluid">
					...
					<div class="header clearfix">
						...
						<a href="index3.html" class="logo"><img src="images/logo.png" alt=""></a>
						...
						<ul class="header-links clearfix">
							<li class="header-number"><i class="icon-telephone114"></i>+91 1800-11-6062</li>
							<li class="header-time"><i class="icon-icons20"></i>24*7</li>
							...
							<ul class="nav nav-pills">
								...
								<li><a href="#">Sign Up<i class="fa fa-caret-down"></i></a>
									<ul class="dropdown-menu">
										...
										<li><a href="reg.php">Customer</a></li>
									</ul>
            ...
            <section class="main-banner margin-0">
	            ...
	            <div class="tp-banner-container">
                    ...
                    <ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb="images/main-banner/3/5.jpg"  data-saveperformance="on"  data-title="">
                            
                            <!-- MAIN IMAGE -->
                            <img src="images/main-banner/3/5.jpg"  alt="" data-lazyload="images/main-banner/3/5.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        </li>
						
						
						
						<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb="images/main-banner/3/6.jpg"  data-saveperformance="on"  data-title="">
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb="images/main-banner/3/7.jpg"  data-saveperformance="on"  data-title="">
							...
							<!-- LAYER NR. 1 -->
                            <!--<div class="tp-caption banner-sub-heading lft rs-parallaxlevel-0"
                                data-x="right"
                                data-y="315" 
            ...
            <section class="bg-blue why-people-chose-us">
				<div class="container">
					...
					<div class="text-center">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="service-box three animate fadeInUp">
							...
							<div class="col-md-4">
								<div class="service-box three animate fadeInUp" data-delay="100">
							...
							<div class="col-md-4">
								<div class="service-box three animate fadeInUp" data-delay="200">
					...
					<div class="footer-top clearfix">
						...
						<div class="row">
							<div class="col-md-3 col-sm-3">
								<div class="footer-logo animate fadeInLeft"><a href="index.html"><img src="images/logo.png" alt=""></a></div>
							</div>
						...
						<div class="footer-left">
							<div class="footer-address-widget clearfix">
								<ul>
									<li><i class="icon-telephone114"></i>+91 1800-11-6062<a href="http://tis.nhai.gov.in/">Toll Tax Information</a></li>
									<li><i class="icon-icons74"></i>Bhatia Toll Plaza,<span>Surat, SH-168, Surat Road, Surat, Surat, Gujarat 394335</span></li>
								</ul>
							</div>
							<div class="row">
								<div class="col-md-6">
				...
				<div class="footer-bottom">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 col-sm-6"><p class="text-right">Designed by <a href="https://www.facebook.com/Siddharth.kans">Siddharth Kansara </a>& <a href="">Bhavik Desai</a></p></div>
						</div>
					</div>
				</div>
