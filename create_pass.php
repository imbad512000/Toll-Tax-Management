                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card" style="height: 800px; width:430px;>
                            ...
                            <div class="card-body" >
                              ...
                              <center><h3 class="auth-title mt-4">Create Pass</h3></center>
                              <br><br>
                                ...
                                <br><br>
                                    <div class="form-group mb-3">
                                      <div class="col-11">
                                        ...
                                        <input class="form-control" type="text" name="hname" required=""  placeholder="Enter your Holder Name">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                            ...
                                            <label for="inputEmail3" class="col-5 col-form-label">Vehicle Class<span class="text-danger"></span></label>
                                            <div class="">
                                              <div class="col-11">
                                                  <select class="form-control" name="type_of_class" data-style="btn-light">
                                    ...
                                    <div class="form-group mb-3">
                                      <div class="col-11">
                                        ...
                                        <input class="form-control" type="text" name="vno" required="" min="0" max="20" placeholder="Enter your Vehicle Number">
                                    </div>

                                   <div class="form-group mb-3">
                                     <label for="inputEmail3" class="col-5 col-form-label">Duration of pass<span class="text-danger"></span></label>
                                            <div class="">
                                              <div class="col-11">
                                                  <select class="form-control" name="edate" data-style="btn-light">
                                    ...
                                    <div class="form-group mb-0 text-center">
                                      <div class="col-11">
                                        <button class="btn btn-danger btn-block" type="submit" name="sub1"> Create Pass </button>
                                    </div>
