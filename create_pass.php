                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class=" card-body">
                                ...
                                <center>
                                    <h3 class="auth-title mt-4">Create Pass</h3>
                                </center>
                                <br><br>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="col-11">
                                                        <label for="inputEmail3" class="col-5 col-form-label">Type of
                                                            Journey<span class="text-danger"></span></label>
                                                        <div class="">
                                                            <div class="col-11">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <label for="inputEmail3"
                                                                class="col-5 col-form-label">Vehicle Class<span
                                                                    class="text-danger"></span></label>
                                                            <div class="">
                                                                <div class="col-11">
                                                                    <select class="form-control" name="type_of_class"
                                                                        data-style="btn-light">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <div class="col-11">
                                                                    ...
                                                                    <input class="form-control" type="text" name="vno"
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    <label for="inputEmail3"
                                                                        class="col-5 col-form-label">Duration of
                                                                        pass<span class="text-danger"></span></label>
                                                                    <div class="">
                                                                        <div class="col-11">
                                                                    ...
                                                                    <div class="form-group mb-5">
                                                                        <div class="col-11">
                                                                            ...
                                                                            <input class="form-control" type="text"
                                                                                name="tamount" required="">
                                                                        </div>
                                                                        <br>
                                                                        <div class="form-group mb-0 text-center">
                                                                            <div class="col-11">
                                                                                <button class="btn btn-danger btn-block"
                                                                                    type="submit" name="sub1"> Create
                                                                                    Pass </button>
                                                                            </div>
