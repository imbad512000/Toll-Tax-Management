                               ...
                               <center><h3 class="auth-title">Create Receipt</h3></center>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="Number" name="tbno" min="0" >
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="vno" required="" min="0" max="10" placeholder="Enter your Vehicle Number">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="Number" name="tamount" required=""  min="0" disabled="disabled">
                                    </div>
